...
def predict_skeleton(input, summary):
    ...
    checkpoint = torch.load('./best_skeleton_model_3_1.pth', map_location=device, weights_only=True)
...
def main():
    ...
    print(f"Listening for UDP packets on {RECV_IP}:{RECV_PORT} ...")
    ...
    try:
        while True:
            ...
            prediction = predict_skeleton(input_data, summary)
